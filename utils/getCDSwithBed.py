...
def get_opts():
	...
	groups.add_argument('-b', '--bed', help='bed file with 4 columns, \"Chr\tstart_pos\tend_pos\tgene_name\"', required=True)
	groups.add_argument('-c', '--cds', help='directory of all cds files, all cds files need end with \".cds\"', required=True)
